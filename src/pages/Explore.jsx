...
import { Filter, Search, Unplug } from 'lucide-react'
import React, { useState, useEffect } from 'react'
import SearchResults from '@/components/shared/SearchResults'
import GridPostList from '@/components/shared/GridPostList'
import { useSearchPosts, useGetPosts } from '@/appwrite/react-query/Mutations'
  ...
  return (
    <div className='explore-container'>
      ...
      {!hasNextPage && !shouldShowSearchResults && (
        ...
        <div className='mt-10 w-full flex flex-1 items-center justify-center gap-2'>
          <Unplug color='#323232'/>
